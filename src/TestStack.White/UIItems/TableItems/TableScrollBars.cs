...
namespace TestStack.White.UIItems.TableItems
{
    public class TableScrollBars : AbstractScrollBars
    {
        ...
        {
            AutomationElement verticalScrollElement = finder.Child(AutomationSearchCondition.ByControlType(ControlType.ScrollBar).WithName(UIItemIdConfigurationLocator.Get().TableVerticalScrollBar));
            ...
            AutomationElement horizontalScrollElement = finder.Child(AutomationSearchCondition.ByControlType(ControlType.ScrollBar).WithName(UIItemIdConfigurationLocator.Get().TableHorizontalScrollBar));
